...
def player_can_move(board, x, y, direction):
    ...
    if obj == "@":
        if direction == "up":
            ...
            if target_obj == "#":
                return False
            elif target_obj == "o" and crate_can_move(board, x, y - 1, "up") == False:
                return False
            else:
                return True
            ...
            if target_obj == "#":
                return False
            elif target_obj == "o" and crate_can_move(board, x, y + 1, "down") == False:
                return False
            else:
                return True
            ...
            if target_obj == "#":
                return False
            elif target_obj == "o" and crate_can_move(board, x - 1, y, "left") == False:
                return False
            else:
                return True
            ...
            if target_obj == "#":
                return False
            elif target_obj == "o" and crate_can_move(board, x + 1, y, "right") == False:
                return False
            else:
                return True
...
def crate_can_move(board, x, y, direction):
    ...
    if obj == "o":
        if direction == "up":
            target_obj = get_symbol(board, x, y - 1)
            if target_obj != "#" and target_obj != "o":
                return True
            else:
                return False
        elif direction == "down":
...
def move_object(board, x, y, direction):
    ...
    elif obj == "o" and crate_can_move(board, x, y, direction):
        if direction == "up":
            board.append(["o", x , y - 1])
            board.remove(["o", x, y])
        elif direction == "down":
            board.append(["o", x , y + 1])
            board.remove(["o", x, y])
        elif direction == "right":
            board.append(["o", x + 1, y])
            board.remove(["o", x, y])
        elif direction == "left":
            board.append(["o", x - 1, y])
            board.remove(["o", x, y])
...
# Huvudprogram
# ======================================================================
board = load_board("first_level.sokoban")
print("Detta är min laddade spelbana:")
display_board(board)
# add_wall(board, 0, 0)
# add_wall(board, 1, 0)
# add_wall(board, 2, 0)
